...
/**
   #PURSES CHARITY (PURSE) --- The largest charity project developed in the Binance network
...
contract SignTest is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xFfe7d7C9238BD538F923b2fA80bC5aDe22A7DCD9;             // Address of the wallet that receives the donation fee!
    ...
    string private _name = "PURSE CHARITY";
    string private _symbol = "PURSES";
    uint8 private _decimals = 9;
     
    uint256 public _taxFee = 2;                     // These values are in %;
    uint256 public _charityFee = 2;                // These values are in %;
    uint256 public _liquidityFee = 3;             // These values are in %;
    ...
    constructor () {
        ...
        //Mian Net
        // Router Pancake Swap V2: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Router Pancake Swap    TestNet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
